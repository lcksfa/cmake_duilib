...
void CAnimationTabLayoutUI::AnimationSwitch()
{
    ...
    if (!m_bIsVerticalDirection) {
        ...
        m_rcCurPos.right = m_rcItem.right;
        m_rcCurPos.top =
            m_rcItem.top - (m_rcItem.bottom - m_rcItem.top) * m_nPositiveDirection;
        m_rcCurPos.bottom =
            m_rcItem.bottom - (m_rcItem.bottom - m_rcItem.top) * m_nPositiveDirection;
    }
...
void CAnimationTabLayoutUI::OnAnimationStep(INT nTotalFrame, INT nCurFrame,
                                            INT nAnimationID)
{
    ...
    if (!m_bIsVerticalDirection) {
        iStepLen =
            (m_rcItemOld.right - m_rcItemOld.left) * m_nPositiveDirection / nTotalFrame;
        ...
        iStepLen =
            (m_rcItemOld.bottom - m_rcItemOld.top) * m_nPositiveDirection / nTotalFrame;
        if (nCurFrame != nTotalFrame) {
