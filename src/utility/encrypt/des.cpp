...
// #include <Common/BWStringConvert.h>
// #include <Common/>

////////////////////////////////////////////////////////////////////////
// initial permutation IP
const char IP_Table[64] = {58, 50, 42, 34, 26, 18, 10, 2, 60, 52, 44, 36, 28, 20, 12, 4,
                           62, 54, 46, 38, 30, 22, 14, 6, 64, 56, 48, 40, 32, 24, 16, 8,
                           57, 49, 41, 33, 25, 17, 9,  1, 59, 51, 43, 35, 27, 19, 11, 3,
                           61, 53, 45, 37, 29, 21, 13, 5, 63, 55, 47, 39, 31, 23, 15, 7};
// final permutation IP^-1
const char IPR_Table[64] = {40, 8, 48, 16, 56, 24, 64, 32, 39, 7, 47, 15, 55, 23, 63, 31,
...
const char P_Table[32] = {16, 7, 20, 21, 29, 12, 28, 17, 1,  15, 23, 26, 5,  18, 31, 10,
                          2,  8, 24, 14, 32, 27, 3,  9,  19, 13, 30, 6,  22, 11, 4,  25};
// permuted choice table (key)
const char PC1_Table[56] = {57, 49, 41, 33, 25, 17, 9,  1,  58, 50, 42, 34, 26, 18,
                            10, 2,  59, 51, 43, 35, 27, 19, 11, 3,  60, 52, 44, 36,
                            63, 55, 47, 39, 31, 23, 15, 7,  62, 54, 46, 38, 30, 22,
                            14, 6,  61, 53, 45, 37, 29, 21, 13, 5,  28, 20, 12, 4};
// permuted choice key (table)
const char PC2_Table[48] = {14, 17, 11, 24, 1,  5,  3,  28, 15, 6,  21, 10,
...
namespace ckbase
{
bool yxDES::RunPad(int nType, const char *In, unsigned datalen, char *Out,
                   unsigned &padlen)
{
    ...
    if (nType == PAD_ISO_1) {
        ...
        memset(Out + datalen + 1, 0x00, 7 - res);
    }
...
//计算并填充子密钥到SubKey数据中
void yxDES::SetSubKey(PSubKey pSubKey, const char Key[8])
{
...
bool yxDES::RunDes(bool bType, bool bMode, char *In, char *Out, unsigned datalen,
...
// DES单元运算
void yxDES::DES(char Out[8], char In[8], const PSubKey pSubKey, bool Type)
{
