...
#include "messagepump/win_message_pump.h"

#if defined(OS_WIN)
#include <list>
#include "messagepump/observer_list.h"
#include "scoped_win_handle.h"
...
public:
    ...
    public:
        ...
        virtual void OnIOCompleted(IOContext *context, DWORD bytes_transferred,
                                   DWORD error) = 0;
    };
