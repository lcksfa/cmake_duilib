...
public:
    ...
    /* NOTE: calling 'ApplyLazyErase' increases the reference count, calling
     * 'ReleaseLazyErase' decreases the reference count */
    int AquireLazyErase()
    {
        return ++lazy_erase_;
    }
...
template <typename ObserverType> class ObserverList : public LazyEraser
{
public:
