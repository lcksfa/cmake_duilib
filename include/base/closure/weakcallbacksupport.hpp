#ifndef __INCLUDE_WEAKCALLBACKSUPPORT_H__
#define __INCLUDE_WEAKCALLBACKSUPPORT_H__
...
template <typename T> class WeakCallback
{
public:
...
private:
    ...
    static std::function<ReturnValue(Param...)>
    ConvertToWeakCallback(const std::function<ReturnValue(Param...)> &callback,
    ...
    -> WeakCallback<decltype(std::bind(f, p, args...))>
{
    ...
    static_assert(std::is_base_of<ckbase::SupportWeakCallback, C>::value,
                  "ckbase::SupportWeakCallback should be base of C");
...
#endif // __INCLUDE_WEAKCALLBACKSUPPORT_H__