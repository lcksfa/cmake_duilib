// This file try to implement a cross flatform message loop,
...
#include "messagepump/default_message_pump.h"
#include "message_loop_proxy.h"        // for MessageLoopProxy
#include "messagepump/observer_list.h" // for ObserverList
#if defined(OS_WIN)
#include "messagepump/win_io_message_pump.h"
#include "messagepump/win_ui_message_pump.h"
#elif defined(OS_POSIX)
#include "messagepump/libevent_message_pump.h"
#endif                            // OS_WIN
...
class MessageLoop : public IMessagePump::ITaskDelegate
{
public:
    enum Type
    {
...
protected:
    ...
    struct PendingTask {
        ...
        PendingTask(const StdClosure &task, ckbase::TimeTicks delayed_run_time,
                    bool nestable);
        ...
        ckbase::TimeTicks delayed_run_time;
    ...
    virtual bool DoWork();
    virtual bool DoDelayedWork(ckbase::TimeTicks *next_delayed_work_time);
    ...
    RunState *state_;
    // 消息泵
    std::shared_ptr<IMessagePump> pump_;
